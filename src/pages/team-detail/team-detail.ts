...
export class TeamDetailPage {
  ...
  ionViewDidLoad() {
    ...
    let teamIDstring = JSON.stringify(this.team.id)
    this.tourneyData = this.teamApi.getCurrentTourney();
    ...
    this.userSettings.isFavoriteTeam(teamIDstring).then(value => this.isFollowing = value);
  }
  ...
  refreshAll(refresher) {
    this.teamApi.refreshCurrent().subscribe(() => {
      refresher.complete();
      this.ionViewDidLoad();
    })
  }
